...
enum {EVALUACION_CURSO=C_1,GESTION_MATERIAS,CONTROL_TAREAS,CONTROL_AGENDA,SALIR};
...
enum{AGREGAR_RECORDATORIO=1,LISTAR_RECORDATORIOS,MOSTRAR_DETALLE_RECORDATORIO,
